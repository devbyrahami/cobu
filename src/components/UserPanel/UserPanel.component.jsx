...
class UserPanel extends React.Component {
  state = {
    ...
    userRef: firebase.auth().currentUser, //alternate way to get user's uid value
  ...
  dropdownOptions = () => [
    ...
    {
      key: "avatar",
      text: <span onClick={this.openModal}>Change Image Profile</span>
    },
    {
      key: "signout",
    ...
    if (this.avatarEditor) {
      this.avatarEditor.getImageScaledToCanvas().toBlob(blob => {
        ...
        this.setState({
          ...
          blob //responsible to send to firebase storage
        });
      });
    }
  };
